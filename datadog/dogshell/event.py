...
class EventClient(object):
    ...
    def setup_parser(cls, subparsers):
        ...
        post_parser.add_argument('--date_happened', type=int, help="POSIX timestamp"
        ...
        stream_parser.add_argument('end', help="end date for the stream request "
                                   "(defaults to 'now')", nargs='?')
        stream_parser.add_argument('--priority', help="filter by priority."
