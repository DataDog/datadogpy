...
class HostsClient(object):
    ...
    def setup_parser(cls, subparsers):
        ...
        list_parser.add_argument('--sort_dir',
        ...
        list_parser.add_argument('--start',
                                 ...
                                 type=int)
        list_parser.add_argument('--count',
                                 help="Number of hosts to return. Max 1000",
                                 type=int,
                                 default=100)
        list_parser.add_argument('--from',
                                 ...
                                 type=int,
                                 dest='from_')
        list_parser.add_argument('--include_hosts_metadata',
    ...
    def _list(cls, args):
        ...
        format = args.format
        res = api.Hosts.get_all(filter=args.filter,
