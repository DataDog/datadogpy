...
class TestBufferedMetric(unittest.TestCase):
    ...
    def test_new_histogram_metric(self):
        s = HistogramMetric(name="test", value=1.0, tags="tag1,tag2", max_metrics=0, rate=1.0)
    ...
    def test_new_distribution_metric(self):
        s = DistributionMetric(name="test", value=1.0, tags="tag1,tag2", max_metrics=0, rate=1.0)
        self.assertEqual(s.data, [1.0])
        self.assertEqual(s.name, "test")
        self.assertEqual(s.tags, "tag1,tag2")
    ...
    def test_new_timing_metric(self):
        s = TimingMetric(name="test", value=1.0, tags="tag1,tag2", max_metrics=0, rate=1.0)
        self.assertEqual(s.data, [1.0])
        self.assertEqual(s.name, "test")
        self.assertEqual(s.tags, "tag1,tag2")
